		...
		<div class="row justify-content-center">
			<div class="col-md-12 col-lg-10">
				<div class="wrap d-md-flex">
					<div class="img" style="background-image: url(${pageContext.request.contextPath}/template/login/img/godchibi.jpg);"></div>
					<div class="login-wrap p-4 p-md-5">
						...
						<p class="text-center">
							Not a member? <a href="${pageContext.request.contextPath}/register">Sign Up</a>
						</p>
					</div>
				</div>
			</div>
