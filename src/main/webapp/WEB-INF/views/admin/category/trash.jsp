...
<c:url var="categoryAPI" value="http://localhost:8080/goodgame/api/category/trash" />
<c:url var="categoryURL" value="http://localhost:8080/goodgame/admin/category/trash" />
									...
									<tr>
										...
										<td>
											<button id="btnRestore" type="button" onclick="warningBeforeRestore()"
												...
												<span>
													<i class="fas fa-trash-restore"> Restore category</i>
												</span>
											</button>									
										</td>
									</tr>
							...
							<c:if test="${empty model.listResult}">
								<tr>
									<td colspan="5" class="text-center">
										<div class=""><strong>The categories haven’t been deteled before!</strong></div>
									</td>									
								</tr>									
							</c:if>
							</tbody>
			...
			swal({
			  ...
			  function() {
			    ...
			    $.ajax({
			        ...
			        data: JSON.stringify(data),
			        success: function(result) {
			        	window.location.href = "${categoryURL}?page=1&limit=10&message=restore_success";
