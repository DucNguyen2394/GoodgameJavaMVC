...
<c:url var="userAPI" value="http://localhost:8080/goodgame/api/user/trash" />
<c:url var="userURL" value="http://localhost:8080/goodgame/admin/user/trash" />
			...
			swal({
			  ...
			  function() {
			    ...
			    $.ajax({
			        ...
			        data: JSON.stringify(data),
			        success: function(result) {
			        	window.location.href = "${userURL}?page=1&limit=10&message=restore_success";
