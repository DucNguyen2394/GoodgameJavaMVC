...
<c:url var="gameEditURL" value="http://localhost:8080/goodgame/dashboard/game/edit" />
				...
				<div class="page-content">
					<div class="row">
						<div class="col-12">
							...
							<form:form class="form-group" role="form" id="formSubmit" modelAttribute="gameDTO" enctype="multipart/form-data">
								<div class="">
